...
class IoController {
 public:
  ...
  static void SaveGraphStruct(const std::string graphName, const Graph& vecGraph,
  ...
  /// Get out-file name
  static std::string BuildOutFileName(const std::string graphName, const std::string algName,
                                      const int seedsize, const std::string probDist,
                                      const float probEdge) {
    if (probDist == "uniform") {
      return graphName + "_" + algName + "_k" + std::to_string(seedsize) + "_" + probDist + "_" +
  ...
  /// Print the results
  static void WriteResult(const std::string& outFileName, const TResult& resultObj,
  ...
  /// Print the seeds
  static void WriteOrderSeeds(const std::string& outFileName, const TResult& resultObj,
                              const std::string& outFolder) {
